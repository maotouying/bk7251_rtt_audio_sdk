...
/*
static void i2s_set_smpration(UINT8 val)
{
    UINT32 value;
...
void i2s_isr(void)
{
...
#if 0
	if(i2s_status & RX_FIFO0_ALMOST_EMPTY)
	{
			...
			i2s_trans.rx_remain_data_cnt -= 32;
	...
	{
		if(32 > i2s_trans.rx_remain_data_cnt)
		{
